...
> v1.0 · 2026-06-10 · the location-by-location data contract for every surface — **all 28 surfaces mapped**.
...
- DERIVED: days-out · **D17** earn<7d · auto-fire flags. Drives scenario auto-fire + Market Brief "Watching."
...
**Status: 28/28 mapped (v1.0).** Shared math always points back to §B; next refinements are per-surface depth + the v4 visual states layered on at Design time.